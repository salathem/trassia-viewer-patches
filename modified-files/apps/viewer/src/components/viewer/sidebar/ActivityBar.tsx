...
// Trassia (Paket U2, seit dem Reste-Paket): die Kundenleiste ist nur noch die
    ...
    <div data-activity-bar className="relative flex flex-col items-center w-12 shrink-0 h-full border-l border-border bg-background">
      ...
      <div className="flex-1 min-h-0 w-full overflow-y-auto overflow-x-hidden py-1.5 flex flex-col items-center gap-0.5">
        {visibleIds.map((id) => {
          ...
          // ist. Ein Seitenpanel gilt bei zusammengeklappter Leiste zwar als
          // "docked" (Information bleibt der Store-Fallback), sichtbar ist es
          // nicht — ohne diese Klemme leuchtete das Information-Symbol ueber
