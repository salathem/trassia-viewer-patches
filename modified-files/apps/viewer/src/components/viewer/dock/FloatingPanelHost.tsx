...
export function FloatingPanelHost() {
  ...
  // coordinates. Track while any floating panel exists: free panels also
  // need the toolbar boundary to keep their header reachable. Kept in sync
  // with sidebar / hierarchy resizes and window resizes (#1245).
  const hasFloating = floatingPanels.length > 0;
